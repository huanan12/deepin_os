...
if __name__ == '__main__':
    muti_all = MultiConcurrence()
    input_path = r"D:\photo\3D_inpainting_test_set\aigc_kuo\image"
    out_path = r"D:\photo\3D_inpainting_test_set\aigc_kuo\image2"
    # value = muti_all.filelist(path)
    # print(value)

    # 移动文件、文件夹
    # muti_all.multi_move_file(input_path,out_path)

    # 复制文件、文件夹
    # muti_all.multi_copy_file(out_path,input_path)

    # 文件重命名
    # muti_all.multi_rename_file(input_path,flag=input_path,num=10)
    muti_all.multi_get_path_write_csv(input_path,num = 1)